...
- [ ] Task 12: Bootstrap uncertainty — Compute bootstrap CIs on cell type fractions from per-cell KNN probabilities. Propagate as heteroscedastic GP noise via FixedNoiseGP. | Acceptance: per-condition noise estimates; 3+ tests
- [ ] Task 13: Data-driven entropy center — Replace arbitrary 0.55 entropy weight in composite fidelity (03_fidelity_scoring.py) with Braun reference mean entropy. | Acceptance: entropy center matches Braun; 2+ tests
