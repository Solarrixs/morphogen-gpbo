...
- [ ] Phase C Idea #9: Adaptive complexity schedule — Round 1: shared lengthscale. Round 2+: per-dim ARD. Round 3+: SAASBO. Auto-select based on N/d ratio. | Acceptance: complexity auto-selected; 3+ tests
